    ...
    return (
        <div className="w-full bg-white pb-10">
            <div className="flex flex-col p-4">
                ...
                <div className="row pt-8 flex justify-between items-center">
                    <div className="left-content">
                        <Link to='/daftar-ka' className="text-[#0080FF] flex items-center text-[16px]" >
                            <svg 
                                width="14" 
                                height="14" 
                                viewBox="0 0 14 14" 
                    ...
                    <div className="right-content flex">
                        ...
                        <button className="w-[187px] h-[52px] px-8 py-[13.5px] font-bold text-white bg-[#DB2D24] flex rounded-lg">
                            <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
                ...
                <div className="navbar pt-7">
                    <div className="row flex justify-around">
                        <div className="left-content">
                            <Link 
                                className="flex items-center text-[#96989C] font-medium"
                                >
                                    <svg 
                                        width="20" 
                                        height="20" 
                        ...
                        <div className="left-content">
                            <Link className="flex items-center text-[#96989C] font-medium">
                                <svg 
                                    width="19" 
                                    height="20" 
                                    viewBox="0 0 19 20" 
            ...
            <div className="detail">
                <div className="bg-[#FFFFFF] p-8 mx-auto mb-8 flex justify-between">
                    {/* right section */}
            ...
            <h2 className="text-[#262627] text-[24px] font-bold p-4">Rute Perjalanan</h2>
            <div className="list-rute px-4 flex flex-col">
                ...
                <ListNumber 
                    label={'2'}
                    rute={'Batang Kuis (BTK)'}/>
                <ListNumber 
                    label={'3'}
                    rute={'Aras Kabu (ARB)'}/>
                <ListNumber 
                    label={'4'}
                    rute={'Lubuk Pakam (LBP)'}/>
                <ListNumber 
                    label={'5'}
                    rute={'Perbaungan (PBA)'}/>
                <ListNumber 
