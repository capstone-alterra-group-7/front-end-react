        ...
        <div className="flex gap-5 w-[42rem]">
          <div className="flex items-center">
            <input
              ...
              id="dari"
              className="bg-[#F9FAFB] py-[7px] px-3 border border-[#D2D7E0] rounded-lg"
            />
          </div>
          ...
          <div className="relative">
            ...
            {showUrutan ? (
              <div
                className={`absolute mt-2 bg-white w-[256px] ${
                  pesananHotel ? "h-[185px]" : "h-[105px]"
                } p-5 shadow-[0_3px_10px_rgb(0,0,0,0.2)] rounded-2xl space-y-4`}
              >
                {sort}
              </div>
            ) : null}
...
export default HeaderPagesDate;
