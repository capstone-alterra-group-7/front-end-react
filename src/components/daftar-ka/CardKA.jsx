...
const CardKA = () => {
  return (
    <div className="w-full h-80 rounded-[32px] bg-[#FFFFFF] p-8 mb-8 flex justify-between border-2 border-[#E1E4EA]">
      {/* right section */}
      <div className="w-[204px]">
        <img src={assets.logoKai} alt="" />
        <h1 className="font-bold text-xl mt-8">
          Putri Deli <span className="font-bold text-[#96989C] text-xl">(Ekonomi)</span>
        </h1>
      ...
      <div className="w-[216px]">
        <button className="w-48 h-10 rounded-2xl font-bold text-white bg-[#0080FF] ms-6">Aktif</button>
        {/* Direction Train */}
