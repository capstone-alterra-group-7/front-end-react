    ...
    <div className="grid gap-6 mb-6 text-[#262627] bg-white p-10">
        <div className="space-y-5">
            <div className="flex items-center gap-5">
                <h1 className="text-[20px] font-[600] text-[#262627]">Status Pengguna</h1>
                <input
                    onChange={(e) => setInput({ ...input, statusAkun: e.target.checked })}
                    value={input.statusAkun}
                    name="statusAkun"
                ...
                <p className="text-[16px] text-slate-900/50 font-[400]">
                    {input.statusAkun ? "Aktif" : "Tidak Aktif"}
                </p>
        </div>
