...
export default function Gerbong() {
        ...
        <div className="pt-[32px] pb-[32px]">
          ...
          <div className="flex">
            ...
            <div className="flex items-center me-[33px] pt-[16px] font-[600]">
              <img src={assets.kursiKosong} alt="kursiKosong" className='max-w-[32px] pe-2 ' />
              <p className='text-[#262627] text-[16px]'>Kosong</p>
            </div>

            <div className="flex items-center pt-[16px]">
              <img src={assets.kursiTerisi} alt="kursiKosong" className='max-w-[32px] pe-2 ' />
