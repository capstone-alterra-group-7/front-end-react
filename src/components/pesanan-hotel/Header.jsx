  ...
  return (
    <div className="bg-white text-[#262627]">
      <div className="grid grid-cols-3 gap-3 px-[32px] py-[16px]">
        <div className="title">
          <h1 className="text-[32px] font-[700]">Daftar Pesanan Hotel</h1>
        </div>
      </div>
      ...
      <div className="grid grid-cols-6 gap-4 px-[32px] py-[16px]">
        <div className="relative col-span-2">
          <input
            ...
            type="text"
            placeholder="Cari data pesanan hotel"
            className=" h-[44px] mt-[1.5px] border w-full border-[#D2D7E0] py-2 px-11  rounded-lg focus:outline-none text-[16px] placeholder:text-[#96989C] placeholder:font-[400]"
          />

          <img
            src={assets.search}
            alt="search"
            className="absolute top-[15.5px] left-3"
          />
        </div>
