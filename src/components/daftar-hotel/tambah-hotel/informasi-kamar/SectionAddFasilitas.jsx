...
const SectionAddFasilitas = ({ fasilitas, setFasilitas }) => {
        ...
        return (
          <div className="relative h-11 mb-4 " key={i}>
            <input
              ...
              value={data.facility}
            />
            <img src={assets.iconClose} alt="" className="absolute right-2 top-[10px]" onClick={(e) => handleDeleteFasilitas(e, data)} />
          </div>
        );
      })}
