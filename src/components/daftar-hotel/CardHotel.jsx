    ...
    <div onClick={handleNavigate}>
      <div className="h-72 rounded-[32px] bg-[#FFFFFF] p-4 mx-auto mb-[1.5rem] flex border-2 border-[#E1E4EA] cursor-pointer">
        ...
        <div className="w-full flex justify-between">
          <div>
            <h1 className="text-[#0080FF] font-semibold text-xl mb-1">
              #{data?.hotel_id}
            </h1>
          ...
          <div className="w-64">
            ...
            <div className="mt-28">
              ...
              <h1 className="text-end text-[#96989C] text-xl font-semibold">
                / kamar / malam
              </h1>
              <h1 className="text-end text-[#FF7300] text-lg">
                Termasuk Pajak
              </h1>
            </div>
          </div>
