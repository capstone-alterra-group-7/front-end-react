    ...
    <div className="navbar pt-4">
      <div className="grid grid-cols-3 border-b border-[#D2D7E0]">
        <div className="w-full space-y-4 cursor-pointer" onClick={() => setNav("informasi")}>
          <button className={`flex items-center mx-auto ${nav === "informasi" ? "text-[#0080FF]" : "text-[#717275] "}  text-[16px] gap-2`}>
        ...
        <div className="w-full space-y-4 cursor-pointer" onClick={() => setNav("daftarKamar")}>
          <button className={`flex items-center mx-auto ${nav === "daftarKamar" ? "text-[#0080FF]" : "text-[#717275] "}  text-[16px] gap-2`}>
        ...
        <div className="w-full space-y-4 cursor-pointer" onClick={() => setNav("ulasan")}>
          <button className={`flex items-center mx-auto ${nav === "ulasan" ? "text-[#0080FF]" : "text-[#717275] "}  text-[16px] gap-2`}>
